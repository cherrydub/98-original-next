...
export default function Cvclean() {
  return (
    <div>
      <div
      ...
      >
        <div className="flex flex-col flex-wrap">
          ...
          <br />
          <p>
            As an experienced IT consultant with a client-centered approach, I
            am highly enthusiastic about programming and dedicated to delivering
            exceptional results. Through my previous work experience and
            personal interests, I have gained extensive expertise in managing
            diverse systems and overseeing company structures, both hardware and
            software. I am known for my exceptional attention to detail and
            strong communication skills, which allow me to ensure outstanding
            user experiences. I am particularly interested in web development
            roles, as I am driven to create products that are user-friendly and
            effective. My enthusiasm for programming and focus on delivering
            high-quality results make me well-suited for any tech-oriented
            position. I look forward to expanding my programming knowledge and
            experience
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            aspiring tech professionals with the skills and knowledge they need
            to succeed in web development. With a focus on progressive learning,
            the program is packed with daily tasks, mini-projects, and
            portfolio-worthy material that challenges and inspires students
            every step of the way
          </p>
          <p>
            - Personally, I found the education to be intense and rewarding,
            with a comprehensive curriculum and a hands-on learning approach
            that provided practical experience in web development. The
            knowledgeable teachers and tutors were always available to offer
            guidance and support, helping me to build a strong portfolio and
            gain valuable insights on how to learn more efficiently
          </p>
          <p>
            ...
            experience has been transformative, not just in terms of my
            technical skills, but also in terms of my mindset and approach to
            learning. I would highly recommend this bootcamp to anyone looking
            to break into the tech industry and make a meaningful impact
          </p>
          <br />
          ...
          <p>
            -Gained valuable experience with Mac-Seven, a leading managed
            service provider serving diverse clients including schools and
            businesses
          </p>
          <p>
          ...
          <p className="italic">SEPT 2007 - JUNE 2008</p>
